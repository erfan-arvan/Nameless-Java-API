...
public final class NamelessAPI {
     ...
     */
    public Optional<String> registerUser(final String username, final String email, IntegrationData... integrationData) throws NamelessException, InvalidUsernameException, UsernameAlreadyExistsException, CannotSendEmailException, IntegrationUsernameAlreadyExistsException, IntegrationIdAlreadyExistsException, InvalidEmailAddressException, EmailAlreadyUsedException {
