...
public enum NamelessVersion {
    ...
    private static final Set<NamelessVersion> SUPPORTED_VERSIONS = // Actually, only pr13 is supported but pr13 development releases still report as pr12
    EnumSet.// Actually, only pr13 is supported but pr13 development releases still report as pr12
    of(V2_0_0_PR_12, V2_0_0_PR_13);
